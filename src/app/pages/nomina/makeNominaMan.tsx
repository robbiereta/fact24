...
import postRequest from "@/app/libComponents/postRequest";
function makeNominaMan(empleado) {
    let fecha=new Date();
    let nomina= {
       "Version": "4.0",
       "Serie": "bvic",
               ...
               "OtrosPagos": 
                   ...
                   let datos_empleado={
                    'SubTotal' : nomina.SubTotal,
                      ...
                      'Emisor' : nomina.Emisor,
                      'Receptor' : nomina.Receptor,
                      'Conceptos' : nomina.Conceptos,
                      'Datos_Nomina12' : nomina.Complemento.Any[0]["Nomina12:Nomina"],
                      'Percepciones' : nomina.Complemento.Any[0]["Nomina12:Nomina"]["Percepciones"],
                      'Deducciones' : nomina.Complemento.Any[0]["Nomina12:Nomina"]["Deducciones"],
                      'OtrosPagos' : nomina.Complemento.Any[0]["Nomina12:Nomina"]["OtrosPagos"]
                      }
                  
 postRequest(process.env.url+"/empleados",datos_empleado)
   
        
       } 

       export default makeNominaMan